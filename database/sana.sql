...
--
-- Table structure for table `scoopy`
--
...
--
-- Dumping data for table `scoopy`
--

INSERT INTO `scoopy` (`user_id`, `name`, `email_id`, `phone`, `password`) VALUES
...
--
-- AUTO_INCREMENT for table `scoopy`
--
ALTER TABLE `scoopy`
